...
<!--                         <img src="/resources/icon/ReadyUp-로고.png" alt=""> -->
         ...
         <nav>
			<ul id="nav2">
				<li class="menuDetail"><a href="/outsou/WebList" class="colorBtn">웹제작</a>
					<ul class="nav2-innav">
						<li class="menuDetaild"><a href="/outsou/WebList?outordMlsfc=OULC01-001">홈페이지 제작</a></li>
						<li class="menuDetaild"><a href="/outsou/WebList?outordMlsfc=OULC01-002">쇼핑몰 제작</a></li>
						<li class="menuDetaild"><a href="/outsou/WebList?outordMlsfc=OULC01-003">랜딩페이지</a></li>
					</ul></li>
				<li class="menuDetail"><a href="/outsou/PGList" class="colorBtn">프로그램</a>
					<ul class="nav2-innav">
						<li class="menuDetaild"><a href="/outsou/PGList?outordMlsfc=OULC01-004">크롤링ㆍ스크래핑</a></li>
						<li class="menuDetaild"><a href="/outsou/PGList?outordMlsfc=OULC01-005">서버ㆍ클라우드</a></li>
						<li class="menuDetaild"><a href="/outsou/PGList?outordMlsfc=OULC01-006">수익자동화</a></li>
					</ul></li>
				<li class="menuDetail"><a href="/outsou/DataList" class="colorBtn">데이터</a>
					<ul class="nav2-innav">
						<li class="menuDetaild"><a href="/outsou/DataList?outordMlsfc=OULC01-007">데이터 구매ㆍ구축</a></li>
						<li class="menuDetaild"><a href="/outsou/DataList?outordMlsfc=OULC01-008">데이터 라벨링</a></li>
						<li class="menuDetaild"><a href="/outsou/DataList?outordMlsfc=OULC01-009">데이터베이스</a></li>
					</ul></li>
				<li class="menuDetail"><a href="/outsou/AIList" class="colorBtn">AI</a>
					<ul class="nav2-innav">
						<li class="menuDetaild"><a href="/outsou/AIList?outordMlsfc=OULC01-010">AIㆍGPT서비스 개발</a></li>
						<li class="menuDetaild"><a href="/outsou/AIList?outordMlsfc=OULC01-011">AIㆍGTP챗봇</a></li>
						<li class="menuDetaild"><a href="/outsou/AIList?outordMlsfc=OULC01-012">프롬포트엔지니어링</a></li>
					</ul></li>
				<li class="menuDetail"><a href="/outsou/JobList" class="colorBtn">직무직군</a>
					<ul class="nav2-innav2">
						<li class="menuDetaild"><a href="/outsou/JobList?outordMlsfc=OULC01-013">UIㆍUX기획</a></li>
						<li class="menuDetaild"><a href="/outsou/JobList?outordMlsfc=OULC01-014">프론트엔드</a></li>
						<li class="menuDetaild"><a href="/outsou/JobList?outordMlsfc=OULC01-015">벡엔드</a></li>
						<li class="menuDetaild"><a href="/outsou/JobList?outordMlsfc=OULC01-016">풀스텍</a></li>
					</ul></li>
				<li class="menuDetail"><a href="/outsou/SIList" class="colorBtn">자기소개서</a>
					<ul class="nav2-innav">
						<li class="menuDetaild"><a href="/outsou/SIList?outordMlsfc=OULC02-001">국내자기소개서</a></li>
						<li class="menuDetaild"><a href="/outsou/SIList?outordMlsfc=OULC02-002">해외자기소개서</a></li>
						<li class="menuDetaild"><a href="/outsou/SIList?outordMlsfc=OULC02-003">대학입시</a></li>
					</ul></li>
				<li class="menuDetail"><a href="/outsou/reviewList" class="colorBtn">리뷰</a></li>
...
//선택한 네비바의 색을 다르게 표시하기 
document.addEventListener('DOMContentLoaded', function () {
    var currentPath = window.location.pathname;  // 현재 경로
    var currentSearch = window.location.search;  // 현재 쿼리 파라미터
    console.log(currentPath + currentSearch);

    // 상위 메뉴와 하위 메뉴를 각각 처리
    $('.colorBtn').each(function() {
        var alinkElement = $(this);
        var linkPath = alinkElement.attr('href').split('?')[0];  // 상위 메뉴 링크 경로

        // 상위 메뉴 활성화 (경로가 일치하면)
        if (currentPath === linkPath) {
            alinkElement.addClass('active2');  // 상위 메뉴에 active2 클래스 추가
        }

        // 하위 메뉴 활성화
        var isSubActive = false;  // 하위 메뉴 활성화 여부를 저장할 변수

        // 해당 상위 메뉴에 속한 하위 메뉴 중 현재 경로와 일치하는지 확인
        alinkElement.closest('li').find('.menuDetaild a').each(function() {
            var hrefValue = $(this).attr('href').split('?')[0];  // 하위 메뉴 링크의 경로
            var hrefQuery = $(this).attr('href').split('?')[1];  // 하위 메뉴 링크의 쿼리 파라미터

            // 현재 경로 + 쿼리 파라미터와 하위 메뉴 링크가 정확히 일치하는지 확인
            if (currentPath === hrefValue && ('?' + hrefQuery === currentSearch || !hrefQuery)) {
                $(this).addClass('sub-active');  // 하위 메뉴 활성화
                alinkElement.addClass('active2');  // 상위 메뉴도 활성화
                isSubActive = true;  // 하위 메뉴 활성화 상태 저장
            }
        });

        // 하위 메뉴가 활성화되지 않은 경우에도 상위 메뉴를 비활성화하지 않음
    });
});

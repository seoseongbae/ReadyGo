...
<div class="container2">
    <header>
   	...
   	<div class="smRegust">
	<div class="size">
    <form name="registForm" id="registForm" action="/adm/notice/admRegistPost"  method="post" enctype="multipart/form-data">
    ...
    <input type="text" hidden id="pstOthbcscope" name="pstOthbcscope" value=""/>
    ...
    <div class="button-container">
        <button type="button" class="faq-btn btn-list" onclick="location.href='/adm/notice/admNoticeList'">취소</button>

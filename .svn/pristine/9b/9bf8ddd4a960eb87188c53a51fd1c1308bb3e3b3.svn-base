...
<c:if test="${entVO ne null and memVO1 eq null}">
<script>
$(function() {
...
<!-- --------------------------------------------------------------------------------------------------- -->
<c:if test="${memVO1 ne null or entVO eq null and memVO1 eq null}">
<script>
$(function() {
	...
	<div class="container">
					   ...
					   <!-- 프로필 메뉴 -->
	                    	<li>
							    <ul id="userMenu">
							        ...
							        <li><a class="menulist" href="/member/scrap?mbrId=${memVO.mbrId}">최근 본 공고</a></li> 
		...
		<nav>
			<ul id="nav2">
				...
				<li class="menuDetail"><a href="/common/jobTools/spellingCheck" class="colorBtn">커리어성장</a>
					<ul class="nav2-innav">
						<li class="menuDetaild"><a class="menuDt" href="/common/jobTools/spellingCheck">취업TOOL</a></li>
						<li class="menuDetaild"><a class="menuDt" href="#">코딩테스트</a></li>
					</ul></li>

...
public class ArticlePage<T> {
    ...
    // 필터 값
    private String pstOthbcscope = "";
    
    // 생성자 : 필터값(pstOthbcscope)와 검색어(keyword)를 추가
    public ArticlePage(int total, int currentPage, int size, List<T> content, String keyword, String pstOthbcscope) {
        this.total = total;
        this.currentPage = currentPage;
        this.content = content;
        this.keyword = keyword;
        this.pstOthbcscope = pstOthbcscope;

...
<div class="container2">
    <header>
   	...
   	<div class="smRegust">
	<div class="size">
    <form name="registForm" id="registForm" action="/adm/inquiryBoard/updatePost"  method="post">
    ...
    <div class="button-container">
        <button type="button" class="faq-btn btn-list" onclick="location.href='/adm/inquiryBoard/admInquiryList'">취소</button>

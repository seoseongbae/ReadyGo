...
<!--   style="position: relative;  z-index: 1; left:10px; top: -900px;  -->
<!--   							   margin-left:600px; border-top:1px solid #e5e5e5; -->
<!--   							   width:1430px;height:700px;background:white; min-height:832px;" -->

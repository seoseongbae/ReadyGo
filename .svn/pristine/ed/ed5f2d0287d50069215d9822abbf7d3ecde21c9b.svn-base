		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column"
				...
				<li class="nav-item nav_main">
					<a href="/enter/pbanc?entId=${prc.username}" class="nav-link"> 
				...
				<li class="nav-item nav_main">
					<a href="/enter/tempPbanc?entId=${prc.username}" class="nav-link"> 
					<img src="/resources/icon/공고임시저장.png" alt="icon">
						<p>
							&nbsp;&nbsp;공고 임시저장
						</p>
					</a>
